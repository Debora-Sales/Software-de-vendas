...
def acao_login(event=None):
    ...
    if perfil:
        ...
        janela.withdraw() # Esconde a janela em vez de destruir para evitar erros de DPI

        app_menu = abrir_menu(janela, perfil[0])
        
        # Garante que fechar o menu encerra o processo do Python completamente
        app_menu.protocol("WM_DELETE_WINDOW", janela.destroy)
